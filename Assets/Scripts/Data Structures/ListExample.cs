...
public class ListExample : MonoBehaviour
{
    ...
    void Start()
    {
        GenerateObjectsFromList(0);
        GenerateObjectsFromList(1);
        GenerateObjectsFromList(2);
        GenerateObjectsFromList(3);
    }
    ...
    void Update()
    {
        ...
        {
            GenerateObjectsFromList(position);
        }

    }

    public void GenerateObjectsFromList(int position)
    {
