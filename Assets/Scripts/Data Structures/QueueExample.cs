...
public class QueueExample : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            var removedObject = queue.Dequeue(); // returns the actual GameObject. Can also use GameObject (but var is used because there can be different data types used)
        ...
        {
            var botGameObject = queue.Peek();
            botGameObject.GetComponent<SpriteRenderer>().color = Color.red;
            Debug.Log("Object at the top of the Queue is " + queue.Peek().name);
        }
